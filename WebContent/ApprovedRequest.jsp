            ...
            <div class="mdl-cell mdl-cell--6-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone">
                <div class="mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title">
                        <h1 class="mdl-card__title-text">Approved Request Status</h1>
                    </div>
                 ...
                 <%   
                					 ...
                					 try
                					 { 
                					 PreparedStatement ps1= con.prepareStatement("select * from cndrequest where status=?");
                	...
                	%>		 
                	       <tbody>
                            <tr>
                                <td class="mdl-data-table__cell--non-numeric"><%=rs1.getInt("cndid") %></td>
                                <td class="mdl-data-table__cell--non-numeric"><%=rs1.getString("title")%></td>
                                <td class="mdl-data-table__cell--non-numeric"><%=rs1.getString("description")%></td>
                                <td class="mdl-data-table__cell--non-numeric"><%=rs1.getString("address")%></td>
                                <td class="mdl-data-table__cell--non-numeric"><%=rs1.getString("status")%></td>
                                

                                <td><a href="complete.jsp?id=<%= rs1.getString("cndid") %>">Completed?</a></td>
