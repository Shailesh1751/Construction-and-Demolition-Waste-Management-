            ...
            <div class="scroller" id="scroller">
                <div class="scroll__container" id="scroll__container">
                    <nav class="mdl-navigation">
                        ...
                        <a class="mdl-navigation__link" href="rcndrequest.html">
                            <i class="material-icons">developer_board</i>
                            Raise CND Request
                        </a>
                       
                         <a class="mdl-navigation__link" href="usercndStat.jsp">
                            <i class="material-icons">developer_board</i>
                            View CND Request Status
                        </a>
                        
                        <a class="mdl-navigation__link" href="userlogin.html">
                            <i class="material-icons">developer_board</i>
                            Log Out
                        </a>
            ...
            <div class="mdl-cell mdl-cell--6-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone">
                <div class="mdl-card mdl-shadow--2dp">
                 ...
                 <%   
                					 ...
                					 try
                					 { 
                					 PreparedStatement ps1= con.prepareStatement("select * from cndrequest where email=?");
                					 ps1.setString(1, getset.getRemail());
