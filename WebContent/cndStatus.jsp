            ...
            <div class="mdl-cell mdl-cell--6-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone">
                <div class="mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title">
                        <h1 class="mdl-card__title-text">View CND Request</h1>
                    </div>
                	...
                	%>		 
                	       <tbody>
                            <tr>
                               ...
                               <td><a href="approve.jsp?id=<%=rs1.getInt("cndid") %>">Approved</a> 
                                <a href="disapprove.jsp?id=<%=rs1.getInt("cndid") %>">Disapproved</a> </td>  
