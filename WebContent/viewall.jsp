...
<title>C&D Waste Management</title>
</head>
<body>
            ...
            <div class="scroller" id="scroller">
                <div class="scroll__container" id="scroll__container">
                    <nav class="mdl-navigation">
                        <a class="mdl-navigation__link mdl-navigation__link--current" href="welcome.html">
                            <i class="material-icons" role="presentation">dashboard</i>
                            Dashboard
                        </a>
                        
                        
                        <a class="mdl-navigation__link" href="addvehicle.html">
                            <i class="material-icons">developer_board</i>
                            Add Vehicle
                        </a>
                       
                         <a class="mdl-navigation__link" href="viewall.jsp">
                            <i class="material-icons">developer_board</i>
                            View All Vehicles
                        </a>
                        
                         <a class="mdl-navigation__link" href="delSpec.html">
                            <i class="material-icons">developer_board</i>
                            Delete Specific Vehicle
                        </a>
                        
                          <a class="mdl-navigation__link" href="updateSpec.html">
                            <i class="material-icons">developer_board</i>
                            Update Specific Vehicle
                        </a>
                        
                         <a class="mdl-navigation__link" href="cndStatus.jsp">
                            <i class="material-icons">developer_board</i>
                            View CND Request Status
                        </a>
                        
                        <a class="mdl-navigation__link" href="ApprovedRequest.jsp">
                            <i class="material-icons">developer_board</i>
                            Approved Request Status
                        </a>
                        
                           <a class="mdl-navigation__link" href="adminLogin.html">
                            <i class="material-icons">developer_board</i>
                            Log Out
                        </a>
                      </nav>
            ...
            <div class="mdl-cell mdl-cell--6-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone">
                <div class="mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title">
                        <h1 class="mdl-card__title-text">View All Vehicles</h1>
                    </div>
                    <div class="mdl-card__supporting-text no-padding">
                        <table class="mdl-data-table mdl-js-data-table bordered-table">
                            ...
                            <tr>
                                ...
                                <th class="mdl-data-table__cell--non-numeric">Driver ContactNo</th>
                                <th class="mdl-data-table__cell--non-numeric">Vehicle No</th>
                                <th class="mdl-data-table__cell--non-numeric">Latitude</th>
                                <th class="mdl-data-table__cell--non-numeric">Longitude</th>
                 ...
                 <%   
                					 ...
                					 try
                					 { 
                					 PreparedStatement ps1= con.prepareStatement("select * from addvehicle");
                	...
                	%>		 
                	       <tbody>
                            <tr>
                                <td class="mdl-data-table__cell--non-numeric"><%=rs1.getInt(1) %></td>
                                <td class="mdl-data-table__cell--non-numeric"><%=rs1.getString(2)%></td>
                                <td class="mdl-data-table__cell--non-numeric"><%=rs1.getString(3)%></td>
                                <td class="mdl-data-table__cell--non-numeric"><%=rs1.getString(4)%></td>
                                <td class="mdl-data-table__cell--non-numeric"><%=rs1.getDouble(5)%></td>
                                <td class="mdl-data-table__cell--non-numeric"><%=rs1.getDouble(6)%></td>
                                <td><a href="delveh.jsp?id=<%= rs1.getString(1) %>">Delete</a></td>
